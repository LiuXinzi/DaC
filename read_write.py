...
dxl_comm_result, dxl_error = packetHandler.write1ByteTxRx(portHandler, DXL_ID, ADDR_OPERATING_MODE, CURRENT_POS_OPERATING_MODE)

dxl_comm_result, dxl_error = packetHandler.write2ByteTxRx(portHandler, DXL_ID, ADDR_GOAL_CURRENT, -1000)
# dxl_current_limit, dxl_error = packetHandler.write1ByteTxRx(portHandler, DXL_ID, ADDR_CURRENT_LIMIT, 1)

# print("current limit:", dxl_current_limit)
